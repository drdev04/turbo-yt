...
def descargar():
    ...
    try:
        ...
        messagebox.showinfo("Éxito", f"Descarga completada correctamente.")
    except subprocess.CalledProcessError as e:
        estado_var.set("Error ❌")
        messagebox.showerror("Error", f"Error al ejecutar yt-dlp:\n\n{e.stderr if e.stderr else str(e)}")

# GUI
ventana = Tk()
ventana.title("Convertir YouTube MP3/MP4")
...
Button(ventana, text="Descargar", command=descargar, bg="green", fg="white", font=("Arial", 12)).pack(pady=10)
